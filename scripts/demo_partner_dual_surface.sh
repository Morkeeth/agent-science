...
# Do not export PARALLEL_API_KEY here — secret_surfaces flags EXPORT of *KEY names.
# parallel field still appears on /health (false without a key); that is enough for
# dual-surface proof. Live Parallel is Oscar deploy + Secret Manager.
export PORT

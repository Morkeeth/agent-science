...
python3 -m pytest -q tests/test_terminal_case_workflow.py tests/test_evidence_cases.py tests/test_research_expansion.py tests/test_research_search.py tests/test_research_contract.py tests/test_studies_synthesis.py tests/test_night_runs.py tests/test_research_workflow.py tests/test_overnight_integration.py tests/test_source_metadata.py tests/test_research_evaluation.py tests/test_morning_integration.py

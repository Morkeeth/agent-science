...
# Overlapping claims must be EXACT assertions — corpus identity is assertion-bound
# (see t_the_corpus_requires_exact_assertion_identity). Paraphrase B scripts are not
# a second production under the shipping engine; they measure zero reuse by construction.
_OFFLINE_CLAIMS = {
    "A": [

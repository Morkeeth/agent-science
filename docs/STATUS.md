...
canonical: true
last-updated: 2026-09-19T08:21:00Z
...
**Last gate run:** 2026-09-19 — partner integrations land · `bench_check_docs.py` **131/131** · `test_watch_it_go_red.py` **72/72** · `prove_partner_health_local` real ADK+SDK · live `/health` still stripped on `00028-hed` · naive ok:true PASS / shipping FAIL (`scripts/eval_hosted_partner_baseline.py`)

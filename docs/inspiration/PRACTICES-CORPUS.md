*Mirrored into Agent Science 2026-08-31 — `docs/inspiration/PRACTICES-CORPUS.md`. Seed claims: `research-inbox/2026-08-31-agentic-practices.md`. Map: `docs/INSPIRATION-PRACTICES-2026-08-31.md`.*

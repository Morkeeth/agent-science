...
**Attempt:** orphan-works / compound A/B on hosted desk for partner honesty land.
...
| Hosted `/partners` · `/truths/ui` | **303** (login / origin redirect) |

## Commands run (2026-09-19)
...
# → naive 3/3 · shipping 0/3 (exit 2) — cannot claim partners on live
```
...
python3 scripts/eval_hosted_partner_baseline.py --offline-fixtures  # scoring OK offline
bash scripts/verify_cold_clone.sh          # stranger path OK
```

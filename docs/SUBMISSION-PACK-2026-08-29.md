...
| ADK default path | `engine_default: adk` | [x] local · hosted after deploy | `docs/RECEIPT-adk-default-path-2026-08-30.md` |
...
**Compound exhibit (offline, 2026-09-15):** `python3 scripts/compound_exhibit_receipt.py` · A=**2**→B=**1** Parallel · B corpus hits=**2** — `docs/COMPOUND-EXHIBIT-2026-08-29.md`. Live hosted (2026-08-31): `long_run_goal.sh` · A=**1**→B=**0** · sealed `docs/SEALED-PREDICTION-2026-08-31.md`. Orphan-works full script: run B **504** — do not claim on video.

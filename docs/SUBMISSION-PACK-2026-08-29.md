...
| Partner integrations | Dual surface in code; live `/health` stripped until Oscar deploy | [x] code · [ ] hosted | `docs/PARTNER-INTEGRATIONS-2026-08-30.md` · `docs/FINDING-hosted-partner-strip-2026-09-08.md` |
| ADK default path | `engine_default: adk` | [x] local · [ ] hosted pending redeploy | `docs/RECEIPT-adk-default-path-2026-08-30.md` |
...
| hosted partner verify | `bash scripts/verify_partners_hosted.sh` | **RED on live 00028-hed** · `--local` green |
| partner surface eval | `python3 scripts/eval_hosted_partner_surface.py` | live: naive wins · local-fix: shipping wins |

**Compound exhibit (offline, re-measured 2026-09-08):** `python3 scripts/compound_exhibit_receipt.py` · A=**2**→B=**1** Parallel · B corpus hits=**2** — `docs/COMPOUND-EXHIBIT-2026-08-29.md` · finding `docs/FINDING-compound-exhibit-integrity-2026-09-08.md` (paraphrase B was inverting the exhibit). Live hosted partners: **RED** on rev 00028 until Oscar dual-surface deploy. Orphan-works full script: run B **504** — do not claim on video.

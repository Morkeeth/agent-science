...
Offline compound receipt writes `docs/COMPOUND-EXHIBIT-2026-08-29.md` with A=2→B=1 Parallel, corpus_hits≥1 — no Gemini/Parallel keys required. `verify_partners_local.sh` proves `engine_default: adk` on the local desk without Cloud Run.
...
| Partner integrations | All four called at runtime | [x] code + local prove · [ ] hosted until Oscar redeploy | `docs/PARTNER-INTEGRATIONS-2026-08-30.md` · `docs/RECEIPT-partner-surfaces-2026-09-13.md` |
| ADK default path | `engine_default: adk` | [x] local · [ ] hosted until Oscar redeploy | `docs/RECEIPT-adk-default-path-2026-08-30.md` · local `verify_partners_local.sh` |

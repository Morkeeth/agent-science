...
| Partner integrations | All four called at runtime | [x] code · [ ] live URL until Oscar deploy | `docs/PARTNER-INTEGRATIONS-2026-08-30.md` · finding `docs/FINDING-hosted-partner-surfaces-2026-09-10.md` |
| ADK default path | `engine_default: adk` | [x] local · hosted health after deploy | `docs/RECEIPT-adk-default-path-2026-08-30.md` · `docs/RECEIPT-partner-night-2026-09-10.md` |

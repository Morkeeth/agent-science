# Deploy prep — slice 1 (Oscar only) · 2026-09-19
...
## Live object (probed 2026-09-19, before deploy)
...
**Diff vs older DEPLOY-PREP-2026-09-03 (stale — do not follow that file):**
...
- [ ] Review `git log --oneline origin/main -10` includes partner-health fix + tonight's cost gate
...
# point at candidate if the script allows HOST override
```
...
Night wave 2026-09-19 did **not** deploy. It re-probed live `00028-hed` (still stripped),
diffed `deploy.sh` against the stale 2026-09-03 prep doc, and left promotion to Oscar.

...
**Date:** 2026-09-12 13:16 UTC · **Subject:** `orphan-works` · **Mode:** offline
...
`python3 clear_corpus.py research-corpus --backfill` → **239 rows** (re-derived at object; not a carried 29) in `cache/refusal_log.db`

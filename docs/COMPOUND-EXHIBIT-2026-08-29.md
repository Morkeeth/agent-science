...
**Date:** 2026-09-11 12:35 UTC · **Subject:** `orphan-works` · **Mode:** offline
...
`python3 clear_corpus.py research-corpus --backfill` → **241 rows** (29 SOURCED + proven-unprovable refusals) in `cache/refusal_log.db`

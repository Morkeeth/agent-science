...
- [x] **Every artifact claim measured at the submitted commit** — `python3 scripts/eval_artifact_claims.py` (2026-09-15: baseline trusts pack; shipping re-derives; caught stale public-repo + commit pin before pack refresh)

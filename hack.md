...
phase: SHIP
last-touched: 2026-09-15 00:15 UTC
canonical: true
...
- [x] Regression controls — `test_partner_runtime` **8/8** · hosted flow anonymous health
- [x] Partner doc + design-partner loop updated for workspace boundary
- [x] Qwen eval gate re-run — baseline 5/6 vs shipping 6/6, delta +1
- [x] SUBMISSION-PACK counts re-derived — **129/129**
- [x] Live compound — **BLOCKED** missing Parallel/Gemini/workspace token (`docs/BLOCKED-live-compound-2026-09-15.md`)
...
bash scripts/verify_partners_hosted.sh                               # PARTIAL until Oscar redeploy
```

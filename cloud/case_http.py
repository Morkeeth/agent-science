...
class WorkspaceHTTP:
    ...
    def route(self):
        ...
        # Measured RED on live 00028-hed (2026-09-18 and re-probed 2026-09-23):
        # anon /truths/ui and /visibility/ui → 303 login; even with a bearer
        # token → 404 because WorkspaceHTTP only mounted /cases. Film preflight
        # failed at object (Transparency / Truths dashboard missing).

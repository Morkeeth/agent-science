...
a stripped liveness JSON is how partner admissibility went dark on revisions
00026-zel and 00028-hed (ok/service/mode/revision only — no gemini/parallel/adk).
"""

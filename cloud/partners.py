...
def manifest(*, gemini_path: str, adk_default: bool) -> dict:
    ...
    return {
        ...
        "partners": {
            ...
            "google_cloud": {
                "role": "Cloud Run dual surface — public desk + private workspaces",
                "module": "cloud/service.py · cloud/partner_status.py · cloud/case_http.py",
                "deploy": "deploy.sh",
                "mode": "private-workspaces+public-desk when AGENT_SCIENCE_HOSTED=1",
                "public_partner_surfaces": ["/", "/clear", "/health", "/partners"],

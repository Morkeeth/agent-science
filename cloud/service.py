...
from cloud import partners as partner_manifest  # noqa: E402 — kept for callers/tests that import via service
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == "/health":
            ...
            return self._json(200, partner_surface.health())

        if path == "/partners":
            from cloud import partners as partner_surface
            return self._json(200, partner_surface.manifest())

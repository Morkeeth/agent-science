...
TOOLS.append({
    ...
    "inputSchema": {"type":"object", "additionalProperties":False, "required":["action"], "properties": {
        ...
        "source_review":{"type":"object","description":"Assessment-scoped authored review of an exact registry warning, source snapshot and inspected notice anchors. Preserves registry history; cannot rehabilitate retracted or superseded evidence."},

...
TOOLS.append({
    ...
    "inputSchema": {"type":"object", "additionalProperties":False, "required":["action"], "properties": {
        "action":{"type":"string","enum":["start","show","context","resume","cancel","reconcile","challenge","update","compare","follow","updates","experiment-plan","protocol","evaluation-create","evaluation-show","evaluation-record","evaluation-review","context-trials","context-trial-create","context-trial-show"]},

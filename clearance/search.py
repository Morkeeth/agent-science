...
def cache_hits() -> int:
    """Cache hits are not Parallel API spend — meter them separately.

    A Parallel drop that is only cache reuse is a soft green, not compound.
    Finding 2026-09-04: naive log_hits masqueraded as Parallel economics.
    """
    return CACHE_HITS

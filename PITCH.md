...
**Proof on disk:** `python3 scripts/seed_document_cache.py && python3 tests/test_watch_it_go_red.py` → **72/72** · ADK engine selection **5/5** · hosted compound **A=1→B=0** Parallel (`docs/SEALED-PREDICTION-2026-08-31.md`).
